...
namespace DeepCsharp.Delegates.co_and_contra_variance
{
  public class CoContravarianceClient
  {
    ...
    public static void DoClientWork()
    {
      ...
      parentClassFactory =
        BuildChildClass; // See the result type. We can use return ChildClass instead of ParentClass IN METHOD.
      ...
      contravarianceDelegate =
        DoSomething; // See the param type. We can use ParentClass instead of ChildClass IN METHOD's params.
      ...
      GenericCovariantDelegate<ParentClass>
        genericCovariantDelegateParent = genericCovariantDelegateChild; // covariance

      GenericCovariantDelegateWoOut<ChildClass> genericCovariantDelegateChildWoOut = BuildChildClass; // same types
      GenericCovariantDelegateWoOut<ParentClass>
        genericCovariantDelegateParentWoOut2 =
          BuildChildClass; // general delegates covariance of delegates is still working
      ...
      GenericContravariantDelegate<ChildClass>
        genericContravariantDelegateChild2 = genericContravariantDelegateParent; // contravariance

      GenericContravariantDelegateWoIn<ParentClass> genericContravariantDelegateParentWoOut = DoSomething; // same types
      GenericContravariantDelegateWoIn<ChildClass>
        genericContravariantDelegateChildWoOut2 =
          DoSomething; // general delegates contravariance of delegates is still working
